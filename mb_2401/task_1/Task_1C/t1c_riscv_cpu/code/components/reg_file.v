...
# Filename:         reg_file.v
# File Description: Implements a 32x32-bit register file for the RISC-V CPU. It features two combinational read ports (rd_data1, rd_data2) and one synchronous write port. Register x0 is hardwired to always read as zero.
