...
// Module Name : uart_rx
//
// Description : UART Receiver with even parity checking.
//               Samples the serial rx line at 115200 baud using a 3.125MHz
//               clock. 5-state FSM: IDLE, START_BIT, DATA_BITS (8 bits),
//               PARITY_BIT, STOP_BIT. Outputs '?' (0x3F) on parity error.
//
// Dependencies: None
...
//
// Inputs      :
//   - clk_3125 : 3.125 MHz clock (115200 × 27 baud)
//   - rx       : UART serial input line
//
// Outputs     :
//   - rx_msg[7:0]  : Received 8-bit message ('?' on parity error)
//   - rx_parity    : Received parity bit
//   - rx_complete  : 1-cycle pulse on successful reception
// =============================================================================
