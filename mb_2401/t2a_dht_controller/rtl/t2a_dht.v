...
// Module Name : t2a_dht
//
// Description : DHT11 Temperature and Humidity Sensor Controller.
//               Uses a 9-state FSM to generate the start signal, read the
//               40-bit data frame from the DHT11, and extract temperature
//               and humidity values with checksum validation.
//
// Dependencies: None
...
//
// Inputs      :
//   - clk_50M : 50 MHz clock input
//   - reset   : Active-low asynchronous reset
//
// Inouts      :
//   - sensor  : Bidirectional data line for DHT11 communication
//
// Outputs     :
//   - T_integral  : 8-bit integer part of temperature value
